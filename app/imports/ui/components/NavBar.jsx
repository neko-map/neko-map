    ...
    return (
      <Menu style={menuStyle} attached="top" borderless id="nav">
        ...
        {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
          <Menu.Item as={NavLink} activeClassName="active" exact to="/volunteeradmin" key='admin' id="font2">Volunteer Admin Page</Menu.Item>
        ) : ''}
        <Menu.Item position="right">
          {this.props.currentUser === '' ? (
            <Dropdown id="login-dropdown" text="Login" pointing="top right" icon={'user'} id="font2">
              <Dropdown.Menu>
